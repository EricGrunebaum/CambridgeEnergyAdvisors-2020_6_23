    ...
    <v-row row wrap>
      ...
      max-width="800">
        ...
        <v-parallax :src="study.photo" alt="" contain="" class="align-center justify-center white--text">
          <v-card-title class="hidden-xs-only" :id="study.name">{{ study.title }}</v-card-title>
  ...
  data: () => {
    return {    
      ...
      studies: [
                  ...
                  {                  
                    title: `Case Study: Series C Raise for Clean Energy Hardware Company`,
                  ...
                  //Sector 2
                  {                  
                    title: `Case Study: Commercial Solar in Harvard Square, Cambridge `, 
