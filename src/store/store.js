        ...
        projects: [
            ...
            { 
              ...
              paragraphs: [
                      ...
                      `Below, left: Current conditions along Rindge Ave. Concrete and chainlink fence across the street from approximately 4,000 affordable housing residents in the three Rindge Towers, Jefferson Park and other properties.`,
                      `Right: Conceptual plan for the Rindge Ave. side of Jerry's Pond. Additional capping with clean soil to create restored, re-naturalized and accessible linear park along Rindge Ave. providing: a more diverse wetland ecosystem with a curving, gradual pond bank, additional space for tree plantings (to mitigate heat-island, improve air quality, add habitat), a meandering walking path to reconnect people with nature, seating for observation of the heron rookery and other species in and around the pond, a sidewalk separated from traffic, a two-way off-road bike path and swales for rainfall absorption into the water table.`
                      ],
            },
             {
                id: 5, 
